...
export class AppComponent {
  ...
  public getGridAreas(): string {
    ...
    // row one
    // show one part
    if (this.state.topLeftVisibility && !this.state.topMiddleVisibility && !this.state.topRightVisibility) {
      rowOne += `${topLeftArea}${topLeftArea}${topLeftArea}${topLeftArea}`;
    } else if (!this.state.topLeftVisibility && this.state.topMiddleVisibility && !this.state.topRightVisibility) {
    ...
    } else if (this.state.middleRightVisibility && this.state.bottomLeftVisibility) {
      rowTwo = `${bottomLeftArea}${bottomLeftArea}${middleRightArea}${middleRightArea}`;
    // do not show middleRight
    } else if (!this.state.middleRightVisibility && this.state.bottomLeftVisibility && this.state.bottomRightVisibility) {
      rowTwo = `${bottomLeftArea}${bottomLeftArea}${middleRightArea}${middleRightArea}`;
    } else if (!this.state.middleRightVisibility && this.state.bottomLeftVisibility && !this.state.bottomRightVisibility) {
      rowTwo = `${bottomLeftArea}${bottomLeftArea}${bottomLeftArea}${bottomLeftArea}`;
    } else if (!this.state.bottomLeftVisibility && !this.state.bottomRightVisibility && this.state.bottomRightVisibility) {
    ...
    } else if (this.state.bottomLeftVisibility && !this.state.bottomRightVisibility) {
